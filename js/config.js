...
viewGame.style.height = heightViewGame + "px";
...
function wheel(){
    ...
    this.actionUp = function(){
        ...
        //     var audio = new Audio('mp3/actionUp-Mp3.mp3');
        //     audio.play();
        // }
        if(this.bottom == 0) {
            var animationUp;
...
function animationLevelUp(){
    ...
    this.createImgLevelUp = function(){
        ...
        this.imgLevelUp.src = "imgs/levelup.png";
...
function level() {
    this.changeLevel = function(maxHeight, aX, y, secondsAnimation){
        if(this.checkLevelUp == 0){
            var audio = new Audio("mp3/levelUp-Mp3.mp3");
            audio.play();
            ++this.checkLevelUp;
...
function game() {
    ...
    this.gameOver = function(){
        var audio = new Audio("mp3/gameOver-Mp3.mp3");
        audio.play();
        this.objwheel.wheel.src = "imgs/wheelError.png";
